...
public abstract class BaseMonsterKnockback : LivingEntity
{
    [Header("Base Stats")]
    [SerializeField]
    ...
    public override void OnDamage(float damage, Vector3 hitPoint, Vector3 hitNormal)
    {
        ...
        if (!isAttacking)
        {
            ...
            knockbackCoroutine = StartCoroutine(KnockbackCoroutine(hitNormal));
        }
    }
    ...
    private IEnumerator KnockbackCoroutine(Vector3 hitNormal)
    {
        ...
        // NavMeshAgent 비활성화해서 Rigidbody가 움직일 수 있게
        agent.enabled = false;
